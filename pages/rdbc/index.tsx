...
export default function Home() {
  ...
  useEffect(() => {
    fetch(`https://hexalts.com/rdbc.md`).then((value) => {
  ...
  return (
    <div className={"relative bg-black"}>
      ...
      <div className="duration-300 flex flex-col bg-white sm:bg-gray-100 container-content">
        <NextSeo
          title={`Hexalts - Realtime Database (client side)`}
          canonical={`https://hexalts.com/rdbc`}
          openGraph={{
            url: `https://hexalts.com/rdbc`,
            title: `Hexalts - Realtime Database (client side)`,
            description: `Simplifies your database query with Hexalts RDBC implementation.`,
          }}
          description={
            "Simplifies your database query with Hexalts RDBC implementation."
          }
        />
        <Head>
          <title>Hexalts - Realtime Database (client side)</title>
          <link
