...
export default function Navbar({ page }: { page: string }) {
    ...
    const activePage = 'bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium'
    const inactivePage = 'text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium'
    return <nav className="bg-black relative">
                ...
                <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                    <div className="flex-shrink-0 flex items-center">
                        <Link href={'/'} passHref={true}>
                            <p className='font-black text-base text-gray-100 cursor-pointer'>Hexalts</p>
                        </Link>
                    </div>
